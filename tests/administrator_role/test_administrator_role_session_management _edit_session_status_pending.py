...
class TestAdministratorRoleSessionManagementEditSessionStatusPending(TestBaseOnline):
	...
	def test_edit_session_row_actions_by_status(self, status_value: str, expect_edit_enabled: bool):
		session_page = self._login_to_session_management()
